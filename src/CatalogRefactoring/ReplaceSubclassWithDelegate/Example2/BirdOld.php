...
class BirdOld
{
    public function __construct(
        ...
        protected string|null $plumage = null,
    ) {
    }
    ...
    public static function  createBird($data)
    {
        switch ($data->type) {
            case 'EuropeanSwallow':
                return new EuropeanSwallowOld($data->name);
            case 'AfricanSwallow':
                return new AfricanSwallowOld($data->name, null, $data->number_of_coconuts);
            case 'NorweigianBlueParrot':
                return new NorwegianBlueParrotOld($data->name, null, $data->number_of_coconuts, $data->is_nailed);
            default:
                return new BirdOld($data->name);
        }
    }
}

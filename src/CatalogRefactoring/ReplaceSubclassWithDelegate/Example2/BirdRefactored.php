...
{
    protected object $special_delegate;
    ...
    public function __construct(
        ...
        $this->special_delegate = $this->selectSpeciesDelegate($data);
    }
    ...
    {
        return  $this->special_delegate->getPlumage();
    }
    public function airSpeedVelocity()
    {
        return  $this->special_delegate->airSpeedVelocity();
    }
    public function  selectSpeciesDelegate($data)
    {
        switch ($data->type) {

...
namespace App\CatalogRefactoring\ReplaceTypeCodeWithSubclasses\Example2;
...
class EmployeeRefactored extends EmployeeType
{
        ...
        {
                if (!in_array($value, ["engineer", "manager", "salesman"]))
                        throw new Exception(`Employee cannot be of type $value`);
        }
        ...
        {
                return $this->name . " ({$this->getCapitalizedType()})";
        }
}

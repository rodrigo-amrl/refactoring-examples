...
class ClientRefactored
{
    ...
    public function getChargeCliente($customer, $usage, $provider)
    {
        $chargeCalculator = new ChargeCalculatorRefactored();
        return $chargeCalculator->getCharge($customer, $usage, $provider);
    }
}
